...
const childProcess = __webpack_require__(35317);
const { isLinux, getReport } = __webpack_require__(44999);
const { LDD_PATH, SELF_PATH, readFile, readFileSync } = __webpack_require__(63699);
const { interpreterPath } = __webpack_require__(73059);
...
const parseOptions = __webpack_require__(84952)
const { safeRe: re, t } = __webpack_require__(25715)
const cmp = __webpack_require__(84978)
const debug = __webpack_require__(57771)
const SemVer = __webpack_require__(72039)
const Range = __webpack_require__(49514)
...
const LRU = __webpack_require__(73515)
const cache = new LRU()

const parseOptions = __webpack_require__(84952)
const Comparator = __webpack_require__(95519)
const debug = __webpack_require__(57771)
const SemVer = __webpack_require__(72039)
const {
  safeRe: re,
  ...
  tildeTrimReplace,
  caretTrimReplace,
} = __webpack_require__(25715)
const { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = __webpack_require__(36537)
...
const debug = __webpack_require__(57771)
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __webpack_require__(36537)
const { safeRe: re, t } = __webpack_require__(25715)

const parseOptions = __webpack_require__(84952)
const { compareIdentifiers } = __webpack_require__(19576)
class SemVer {
...
const eq = __webpack_require__(39070)
const neq = __webpack_require__(35154)
const gt = __webpack_require__(81475)
const gte = __webpack_require__(81472)
const lt = __webpack_require__(47423)
const lte = __webpack_require__(40761)
...
const SemVer = __webpack_require__(72039)
const parse = __webpack_require__(98189)
const { safeRe: re, t } = __webpack_require__(25715)
...
const compare = __webpack_require__(67377)
...
const is = __webpack_require__(94651);
...
const color = __webpack_require__(7007);
const is = __webpack_require__(94651);
...
const Sharp = __webpack_require__(35631);
__webpack_require__(31471)(Sharp);
__webpack_require__(4603)(Sharp);
__webpack_require__(24588)(Sharp);
__webpack_require__(95254)(Sharp);
__webpack_require__(58831)(Sharp);
__webpack_require__(97572)(Sharp);
__webpack_require__(66226)(Sharp);
__webpack_require__(57275)(Sharp);
...
const is = __webpack_require__(94651);
const sharp = __webpack_require__(19247);
...
const { spawnSync } = __webpack_require__(31421);
const { createHash } = __webpack_require__(77598);
const semverCoerce = __webpack_require__(96525);
const semverGreaterThanOrEqualTo = __webpack_require__(81472);
const semverSatisfies = __webpack_require__(54119);
const detectLibc = __webpack_require__(10240);

const { config, engines, optionalDependencies } = __webpack_require__(62909);
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    ...
    try {
      return __webpack_require__(16271);
    } catch {}
  }
  return '';
};
...
const buildSharpLibvipsCPlusPlusDir = () => {
  ...
  try {
    return __webpack_require__(45316);
  } catch {}
  return '';
};
...
const { familySync, versionSync } = __webpack_require__(10240);

const { runtimePlatformArch, isUnsupportedNodeRuntime, prebuiltPlatforms, minimumLibvipsVersion } = __webpack_require__(14172);
...
const events = __webpack_require__(78474);
const detectLibc = __webpack_require__(10240);

const is = __webpack_require__(94651);
const { runtimePlatformArch } = __webpack_require__(14172);
const sharp = __webpack_require__(19247);
...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    ...
    try {
      versions = __webpack_require__(98140);
    } catch (_) {}
  }
}
versions.sharp = (__webpack_require__(62909).version);
...
if (detectLibc.familySync() === detectLibc.GLIBC && !sharp._isUsingJemalloc()) {
  ...
  sharp.concurrency((__webpack_require__(48161).availableParallelism)());
}
...
module.exports = __webpack_require__(27594)["default"];
